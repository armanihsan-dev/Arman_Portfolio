  ...
  return (
    ...
    >
      <CardBody className="relative group/card-container  bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 w-full h-full rounded-2xl p-8 border border-slate-700/30 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-700">
        ...
        {/* Shimmer effect */}
        <div
          className="absolute inset-0 rounded-2xl opacity-0 group-hover/card-container:opacity-100 transition-all duration-1000 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover/card-container:translate-x-full"
        ...
        >
          <div className="relative h-48 w-full overflow-hidden group/image">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-transparent to-emerald-500/10 opacity-0 group-hover/card-container:opacity-100 transition-opacity duration-500" />
            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-indigo-500/5 opacity-0 group-hover/card-container:opacity-100 transition-opacity duration-700" />

            <div className="absolute top-4 right-4 opacity-0 group-hover/card-container:opacity-100 transition-all duration-300 transform translate-y-2 group-hover/card-container:translate-y-0">
              <div className="w-3 h-3 bg-purple-400 rounded-full animate-pulse shadow-lg shadow-purple-400/50" />
            </div>

            <div className="absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-emerald-400/30 opacity-0 group-hover/card-container:opacity-100 transition-all duration-500 delay-200" />
            <div className="absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-purple-400/30 opacity-0 group-hover/card-container:opacity-100 transition-all duration-500 delay-300" />
          </div>
        </CardItem>
        ...
        {/* Corner accents */}
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-purple-500/15 via-purple-400/5 to-transparent rounded-2xl opacity-60 group-hover/card-container:opacity-100 transition-opacity duration-500" />
        <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-emerald-500/15 via-emerald-400/5 to-transparent rounded-2xl opacity-60 group-hover/card-container:opacity-100 transition-opacity duration-700" />

        <div className="absolute top-4 right-4 w-2 h-2 bg-purple-400/40 rounded-full opacity-0 group-hover/card-container:opacity-100 transition-opacity duration-500 delay-200" />
        <div className="absolute bottom-4 left-4 w-2 h-2 bg-emerald-400/40 rounded-full opacity-0 group-hover/card-container:opacity-100 transition-opacity duration-500 delay-300" />
      </CardBody>
    </CardContainer>
  );
}
